package com.hxb.demo.test.entity;
 ...
 *
 */
public class LoanApply extends BaseEntity<LoanApply> {
	/**
	 * 序列号
	 */
	...
	private Integer applyCount;    // 贷款申请次数
	private Integer loanSuccCount;    // 贷款成功次数
	private String channelId;		// 渠道码（树形结构）
	private String salerId;		// 推荐人ID
	private String extInfo;		// 扩展信息
	private String channel;		// 渠道（进件、引流）
